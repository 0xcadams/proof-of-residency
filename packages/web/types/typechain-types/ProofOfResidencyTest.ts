...
export interface ProofOfResidencyTestInterface extends utils.Interface {
  functions: {
    ...
    "cityMintLimit(uint256)": FunctionFragment;
    "cityValue(uint256)": FunctionFragment;
    "commitAddress(address,bytes32)": FunctionFragment;
    "contractURI()": FunctionFragment;
    "currentCityCount(uint256)": FunctionFragment;
    ...
    "incrementCityCount(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cityMintLimit",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "cityValue",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "currentCityCount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "incrementCityCount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "cityValue", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "commitAddress",
    data: BytesLike
  ): Result;
...
export interface ProofOfResidencyTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProofOfResidencyTestInterface;
  ...
  cityValue(city: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
